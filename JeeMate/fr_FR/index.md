...
**Note: JeeMate ne reconnaitra seulement que les équipements visibles contenant des commandes avec types génériques. N'oubliez donc pas de renseigner les types génériques si ce n'est déjà fait.**
...
Pour ajouter un favoris (Equipements, Scénarios, Groupes, Appli Android), cliquer sur le bouton "+" correspondant à la section, sur la gauche de l'écran
...
- Pour réorganiser l'ordre d'affichage, appuyer quelques secondes sur l'équipement et déplacer la tuile à l'endroit souhaité.
...
- Ajouter un design
- de choisir d'afficher le design par défaut au démarrage de JeeMate
...
- la géolocalisation (Activer, définir des zones, affiner les réglages pour le géofencing et la durée batterie)
...
- Activer le service SMS pour recevoir ou envoyer des SMS, avec gestion d'un liste blanche des contacts
...
## Connecteur Jeedom
- Activer/Désactiver la connection avec votre serveur Jeedom
...
- Tester la connection : permet de tester la connection entre l'application mobile et votre serveur Jeedom
...
JeeMate permet de contrôler votre Jeedom, en mode offline. C'est-à-dire que que la reconnaissance du hotword ainsi que la transcription de la voix en texte est faite sur votre appareil, et ne passe pas par le cloud.
